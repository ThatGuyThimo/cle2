...
if (isset($_POST['submit']) && isset($_POST['id'])) {
    ...
    if ($_FILES['image']['error'] == 4) {
       $image = $_POST['backupimage'];
    } else {
        deleteImageFile($_POST['backupimage']);
    ...
    if (empty($errors)) {
        ...
        $query = "UPDATE cases SET name = '$casename', external = '$external', internal = '$internal', coverdepth = '$coverdepth', weight = '$weight', temp = '$temp', image = '$image', trollycase = '$trollycase'
                  WHERE `id` = $_POST[id]";
        $result = mysqli_query($db, $query) or die('Error: '.mysqli_error($db). ' with query ' . $query);
        ...
        <section class="boxsizing">
            <div id="main" class="main-content flex-1 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="text-4xl text-black">
                    <h1 class="text-skew font-asp font-bold py-4 pl-2">Edit case: <?= $case['name'] ?></h1>
                </div>
                ...
                <div class="w-full">
                    <div class="container bg-white border-2 rounded-md border-gray-200">
                        ...
                        <div>
                            ...
                            <input name="backupimage" id="backupimage" value="<?= $case['image'] ?>" hidden>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="casename">Case name</label>
                                    <input type="text" id="casename" name="casename" value="<?= $case['name']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                ...
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="external" id="external" name="external" value="<?= $case['external']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['external'] ?? '' ?>
                                    </p>
                                </div>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="internal" id="internal" name="internal" value="<?= $case['internal']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['internal'] ?? '' ?>
                                    </p>
                                </div>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="coverdepth" id="coverdepth" name="coverdepth" value="<?= $case['coverdepth']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['coverdepth'] ?? '' ?>
                                    </p>
                                </div>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="weight" id="weight" name="weight" value="<?= $case['weight']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['weight'] ?? '' ?>
                                    </p>
                                </div>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="temp" id="temp" name="temp" value="<?= $case['temp']?>" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['temp'] ?? '' ?>
                                    </p>
                                </div>
                                <div class="mb-6 pt-3 rounded bg-gray-200">
                                    ...
                                    <input type="checkbox" id="trollycase" name="trollycase" <?= $trolly?> class="bg-gray-200 rounded w-10 text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-[#EF7D00] transition duration-500 px-3 pb-3">
                                    <p class="help is-danger">
                                        <?= $errors['trollycase'] ?? '' ?>
                                    </p>
                                </div>
                                ...
                                <div class="flex flex-row">
                                        <button class="rounded button-slanted text-center inline-block bg-[#EF7D00] hover:bg-[#2D2D2D] transition duration-500 ease-in-out" type="submit" name="submit">
                                            <p class="font-asp px-3 py-2 text-xl font-bold text-white button-slanted-content uppercase focus:outline-none">Save</p>
                                        </button>
